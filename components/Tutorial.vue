...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet beatae, provident. Assumenda cum, eaque eius est
      excepturi hic libero perferendis perspiciatis rerum totam velit voluptatibus voluptatum. Esse harum minus,
      nesciunt odit omnis quos reprehenderit sint totam ut vitae. Ab beatae dolore excepturi hic illo itaque magni non
      nostrum quam quo.
    </div>
  </div>
</template>
